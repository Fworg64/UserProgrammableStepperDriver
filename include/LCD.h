...
void lcd_init (void (*send)(char *, unsigned char)); // send this a pointer to a function that sends serial data
void lcd_reset (void);
...
void lcd_send_string (char *string); //MUST BE NULL TERMINATED OR UNIVERSE WILL IM(EX)PLODE
